...
def create_database():
    ...
    cursor.execute("INSERT INTO Employees VALUES (1, 'Alice', 1, 50000, '2021-01-15')")
    cursor.execute("INSERT INTO Employees VALUES (2, 'Bob', 2, 70000, '2020-06-10')")
    cursor.execute("INSERT INTO Employees VALUES (3, 'Charlie', 3, 60000, '2022-03-20')")
    cursor.execute("INSERT INTO Employees VALUES (4, 'David', 4, 65000, '2019-08-25')")
    cursor.execute("INSERT INTO Employees VALUES (5, 'Eve', 5, 72000, '2018-11-30')")
    cursor.execute("INSERT INTO Employees VALUES (6, 'Frank', 1, 55000, '2022-05-12')")
    cursor.execute("INSERT INTO Employees VALUES (7, 'Grace', 2, 73000, '2020-02-17')")
